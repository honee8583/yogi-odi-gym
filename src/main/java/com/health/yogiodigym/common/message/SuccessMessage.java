...
public enum SuccessMessage {
    ...
    GET_CALENDAR_LESSON_SUCCESS("강의정보를 불러오는데 성공하였습니다."),
    GET_ONE_CALENDAR_LESSON_SUCCESS("해당날짜의 강의정보를 불러오는데 성공하였습니다."),
    GET_CALENDAR_EXERCISE_SUCCESS("운동정보를 불러오는데 성공하였습니다."),
    GET_ONE_CALENDAR_EXERCISE_SUCCESS("해당날짜의 운동정보를 불러오는데 성공하였습니다."),
    POST_CALENDAR_EXERCISE_SUCCESS("운동정보를 삽입하는데 성공하였습니다."),
    PUT_CALENDAR_EXERCISE_SUCCESS("운동정보를 수정하는데 성공하였습니다."),
    DELETE_CALENDAR_EXERCISE_SUCCESS("운동정보를 삭제하는데 성공하였습니다."),
    GET_CALENDAR_FOOD_SUCCESS("식단정보를 불러오는데 성공하였습니다."),
    GET_ONE_CALENDAR_FOOD_SUCCESS("해당날짜의 식단정보를 불러오는데 성공하였습니다."),
    POST_CALENDAR_FOOD_SUCCESS("식단정보를 삽입하는데 성공하였습니다."),
    PUT_CALENDAR_FOOD_SUCCESS("식단정보를 수정하는데 성공하였습니다."),
    DELETE_CALENDAR_FOOD_SUCCESS("식단정보를 삭제하는데 성공하였습니다."),
    GET_CALENDAR_MEMO_SUCCESS("메모를 불러오는데 성공하였습니다."),
    GET_ONE_CALENDAR_MEMO_SUCCESS("해당날짜의 메모를 불러오는데 성공하였습니다."),
    POST_CALENDAR_MEMO_SUCCESS("메모 삽입에 성공하였습니다."),
    PUT_CALENDAR_MEMO_SUCCESS("메모 수정에 성공하였습니다."),
    DELETE_CALENDAR_MEMO_SUCCESS("메모를 삭제하는데 성공하였습니다."),
    GET_DATA_EXERCISE_SUCCESS("운동 데이터를 불러오는데 성공했습니다."),
    GET_ONE_DATA_EXERCISE_SUCCESS("운동 정보를 불러오는데 성공했습니다."),
    GET_DATA_FOOD_SUCCESS("운동 데이터를 불러오는데 성공했습니다."),
    GET_ONE_DATA_FOOD_SUCCESS("운동 정보를 불러오는데 성공했습니다."),

    REGIST_SUCCESS("회원가입에 성공하였습니다."),
    REGISTER_BOARD_SUCCESS("게시판 작성에 성공하였습니다."),
    SEARCH_BOARD_SUCCESS("게시판 조회에 성공하였습니다."),
    UPDATE_BOARD_SUCCESS("게시판 수정에 성공하였습니다."),
    ...
    ADMIN_MEMBER_STATUS_CHANGE_SUCCESS("회원 비활성화에 성공하였습니다."),
    ...
    MAIL_VERIFY_SUCCESS("메일인증에 성공하였습니다."),
